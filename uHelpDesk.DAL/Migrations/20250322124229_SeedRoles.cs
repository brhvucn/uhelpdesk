...
namespace uHelpDesk.DAL.Migrations
{
    ...
    public partial class SeedRoles : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
           ...
           //     });
            //
            migrationBuilder.Sql("INSERT INTO AspNetRoles (Id, Name, NormalizedName, ConcurrencyStamp) VALUES ('" + Guid.NewGuid() + "', 'Admin', 'ADMIN', '" + Guid.NewGuid() + "')");
            migrationBuilder.Sql("INSERT INTO AspNetRoles (Id, Name, NormalizedName, ConcurrencyStamp) VALUES ('" + Guid.NewGuid() + "', 'SupportAgent', 'SUPPORTAGENT', '" + Guid.NewGuid() + "')");
            migrationBuilder.Sql("INSERT INTO AspNetRoles (Id, Name, NormalizedName, ConcurrencyStamp) VALUES ('" + Guid.NewGuid() + "', 'Customer', 'CUSTOMER', '" + Guid.NewGuid() + "')");
            migrationBuilder.Sql("INSERT INTO AspNetRoles (Id, Name, NormalizedName, ConcurrencyStamp) VALUES ('" + Guid.NewGuid() + "', 'Supervisor', 'SUPERVISOR', '" + Guid.NewGuid() + "')");
            migrationBuilder.Sql("INSERT INTO AspNetRoles (Id, Name, NormalizedName, ConcurrencyStamp) VALUES ('" + Guid.NewGuid() + "', 'Auditor', 'AUDITOR', '" + Guid.NewGuid() + "')");
        /*
            migrationBuilder.CreateTable(
                name: "AspNetUsers",
                columns: table => new
